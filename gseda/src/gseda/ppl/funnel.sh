...
python subreads_smc_funnel_stat.py /data1/REF_GENOMES/MG1655.fa  \
    ...
    --smc_bams \
        /data1/ccs_data/202603-good-ecoli-data/20260311_240601Y0012_Run0003.delinfo.smc_all_reads.bam \
        /data1/ccs_data/202603-good-ecoli-data/20260311_240601Y0012_Run0003.delinfo.smc_all_reads.with_di.q20.bam \
    --sbr_qv_thr 10
