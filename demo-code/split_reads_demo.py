...
def plot_len_dist(lengths):
    ...
    # 保存为JPEG
    plt.savefig('length_distribution.jpg', dpi=300, format='jpeg')
    print("图像已保存为 'length_distribution.jpg'")
...
def main():
    fpath = "/root/projects/gsda/demo-code/Single-0_Double-296.fastq"
    tot = 0
    splitted = 0
